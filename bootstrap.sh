...
erlc -D BOOTSTRAP -o "${STAGE1_DIR}/ebin" -I include vendor/typerefl/src/typerefl.erl src/anvl_resource.erl src/anvl_condition.erl src/anvl_lib.erl src/anvl_hook.erl src/anvl_erlc.erl src/anvl_sup.erl src/anvl_app.erl
