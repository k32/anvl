...
%% API
-export([documented/2, model_doc/1]).
...
?MEMO(documented, ProjectRoot, Format,
      begin
        ...
        Dir = anvl_plugin:conf([anvl_plugin_builder, doc_dir]),
        ...
        precondition([model_doc(I) || I <- cfg_plugins(ProjectRoot)]) or
          ...
          begin
            ...
            anvl_lib:exec("texi2any", ["-c", "INFO_JS_DIR=js", "-I", Dir, "--" ++ atom_to_list(Format), "-o", Output, DocSrc])
          end
      end).
